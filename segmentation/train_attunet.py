...
# from model.segmentation.DeepLabv3_plus import DeepLabv3_plus   # DeepLabv3+模型
from model.segmentation.AttUNet import AttUNet_ResNet18
...
def main():
    ...
    #     _print=True
    # )
    model = AttUNet_ResNet18(output_ch=opt.model['out_c'])
